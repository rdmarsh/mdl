class LicensesController < ApplicationController
  ...
  def create
    ...
    if @license.save
      ...
      flash[:info] = "Successfully created license '" + @license.name + "'"
    else
      flash[:error] = "Could not create license '" + @license.name + "'"
    end
  ...
  def update
    ...
    if @license.update_attributes(license_params)
      ...
      flash[:info] = "Successfully updated license '" + @license.name + "'"
    else
      flash[:error] = "Could not update license '" + @license.name + "'"
    end
  ...
  def destroy
    ...
    if @license.destroy
      flash[:info] = "Successfully deleted license '" + @license.name + "'"
    else
      flash[:error] = "Could not delete license '" + @license.name + "'"
    end
